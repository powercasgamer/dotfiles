...
└── zsh/
    ...
    ├── aliases.zsh    # shortcuts: git, ls, navigation, apt, safety nets
    ├── exports.zsh     # env vars: EDITOR, history size, PATH, less colors
    └── functions.zsh  # mkcd, extract, bak, psgrep
```
...
`source ~/.zshrc`, defined in `aliases.zsh`).
